...
class MovieDescribe extends StatefulWidget {
  MovieDescribe({Key key, @required this.vod});

  VodModel vod;

  @override
  _MovieDescribeState createState() => _MovieDescribeState(vod: this.vod);
}

class _MovieDescribeState extends State<MovieDescribe> {
  _MovieDescribeState({Key key, @required this.vod});
