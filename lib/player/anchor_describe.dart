...
class AnchorDescribe extends StatefulWidget {
  AnchorDescribe({Key key, @required this.anchor});

  AnchorModel anchor;

  @override
  _AnchorDescribeState createState() => _AnchorDescribeState(anchor: this.anchor);
}

class _AnchorDescribeState extends State<AnchorDescribe> {
  _AnchorDescribeState({Key key, @required this.anchor});
  ...
  // 视频详情
  Widget AnchorDescribe() {
    return Container(
//      child: ExpansionTile(
      child: new Column(
//        title: Text('${this.anchor.anchorName}',maxLines: 2),
        children: <Widget>[
//          Row(
//            children: <Widget>[
          Text('${this.anchor.name}', maxLines: 1,
              textAlign: TextAlign.left),
          Text('${this.anchor.content}', maxLines: 10)
          //	],
          // )
        ],
