...
class LeaguePage extends StatefulWidget {
  LeaguePage({Key key, @required this.day, @required this.name});

  String name;
  int day = 0;

  @override
  _LeaguePageState createState() =>
      _LeaguePageState(day: this.day, name: this.name);
}

class _LeaguePageState extends State<LeaguePage> {
  _LeaguePageState({Key key, @required this.day, @required this.name});
  ...
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
        ...
        home: new Scaffold(
          ...
          body: (leagueProgramList.length < 1)
              ? refreshButton(this)
              : RefreshIndicator(
